...
public class PantallaAgregar extends javax.swing.JPanel {

    Controladora control;
    User usr;

    public PantallaAgregar(Controladora control, User usr) {
    ...
    private void initComponents() {
        ...
        txtNumeroDoc.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                txtNumeroDocMouseClicked(evt);
            }
        });
        jPanelTransparente1.add(txtNumeroDoc, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 170, 210, 30));

        cmbTipoDoc.setFont(new java.awt.Font("Segoe UI Symbol", 0, 14)); // NOI18N
        cmbTipoDoc.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Elija una Opcion", "Cédula de Ciudadanía:", "Tarjeta de Identidad:", "Registro Civil:" }));
    ...
    private void btnGuardaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardaActionPerformed
        ...
        if(txtNumeroDoc.getText().isEmpty() || txtNombre.getText().isEmpty() 
          || txtApellido.getText().isEmpty() || txtFechaNac.getText().isEmpty()
          || cmbTipoDoc.getSelectedIndex()==0){
        JOptionPane.showMessageDialog(jEImagePanel2, "Debe llenar todos los campos");
        }else{
        ...
        control.crearIndigena(tipoDoc, numeroDoc, nombre, apellido, fechaNac);
        JOptionPane.showMessageDialog(null, "Integrante creado correctamente");
    ...
    private void txtNumeroDocMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtNumeroDocMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_txtNumeroDocMouseClicked
