...
public class EditarUsu extends javax.swing.JPanel {
    
    int id_usuarios;
    Controladora control;
    User usr;

    public EditarUsu(Controladora control, User usr,int id_usuarios) {
        ...
        //Metodo para traer los usuarios Buscar los datos y los cargo a la interfaz con el metodo para traer los ususrios
        
        usr = control.traerUsuario(id_usuarios);
        
        //se cargan los datos en la interfax
        txtUsuario.setText(usr.getNombreUsu());
        txtContrasenia.setText(usr.getContrasenia());
    ...
    private void initComponents() {
        ...
        jLabel6.setText(" Editar nuevo usuario");
    ...
    private void btnGuardaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardaActionPerformed
        ...
        control.editarUsuario(usr,usuario, contra, rol);
//        
...
//        txtContrasenia.setText("");
        ...
        JOptionPane.showMessageDialog(null, "El objeto de usuario es nulo");   
        }
